...
public class Mahasiswa21A extends Mahasiswa{
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tot_data; i++) {
            ...
            System.out.println("===============================");
            Mahasiswa21A azkia = new Mahasiswa21A(nim, nama, nilai);
            daftar.add(azkia);
            if (azkia.isLulus()) {
                tot_lulus++;
                nm_lulus += nama + ", ";
            ...
            if (azkia.getGradeGG() == 'A') {
                nil_a++;
                nm_a += nama + ", ";
            } else if (azkia.getGradeGG() == 'B') {
                nil_b++;
                nm_b += nama + ", ";
            } else if (azkia.getGradeGG() == 'C') {
                nil_c++;
                nm_c += nama + ", ";
            } else if (azkia.getGradeGG() == 'D') {
                nil_d++;
                nm_d += nama + ", ";
            } else if (azkia.getGradeGG() == 'E') {
                nil_e++;
                nm_e += nama + ", ";
            }
            tot_nilai += nilai;
